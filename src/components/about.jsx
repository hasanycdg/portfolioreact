      ...
      <div className='md:p-22 md:pt-24 md:pb-22 md:px-40 md:h-full select-none bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] bg-[white] p-8 md:flex justify-normal space-x-28 md:mt-0 mt-6 pt-16'>
        <div className='md:w-6/12'>
            ...
            <div className='md:pt-5'>
                <h1 className='md:text-5xl text-4xl md:font-medium font-semibold'>Senior CS Student <br className='md:hidden'/><span className='bg-gradient-to-r from-[#833be7cb] to-[#5521c5] bg-clip-text text-transparent md:w-48'>Data enthusiast </span><br/> <span className='md:text-4xl text-3xl font-poppins font-normal md:font-medium'>Based In Austria.</span></h1>
            ...
            <div className='md:w-12/12 md:mt-10 '>
                <h1 className='font-poppins text-justify'>As a final-semester Computer Science student at the University of Innsbruck, I've cultivated expertise beyond my core studies, actively exploring diverse technical fields. My natural adaptability allows me to quickly master new technologies and software environments. Combining a passion for innovation with meticulous attention to detail, I excel in collaborative environments, consistently driving projects to successful completion while maintaining the highest standards of quality. </h1>
            </div>
        </div>
        <div className='relative md:-left-0 -left-28 md:pt-4 pt-12'>
            <div className='md:w-96'>
                ...
                <h1 className='md:mt-5 mt-3 md:ml-2 font-poppins'><GoDot className='inline'/><span className='md:pl-12  text-xl pl-4'>German</span></h1>
                <h1 className='md:mt-2 md:ml-2 font-poppins'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>English</span></h1>
                <h1 className='md:mt-2 md:ml-2 font-poppins mb-2'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>Turkish</span></h1>
                <h1 className='md:mt-2 md:ml-2 font-poppins mb-2'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>Kurdish</span></h1>
            ...
            <div className='md:mt-3'>
                ...
                <h1 className='md:mt-4 md:ml-2 font-poppins'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>Turkish</span></h1>
            </div>
