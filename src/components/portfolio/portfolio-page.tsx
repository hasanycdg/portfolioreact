...
const copy = {
  de: {
    ...
    facts: [["Rolle", "Lead Fullstack Developer"], ["Ausbildung", "BSc Informatik · Universität Innsbruck"], ["Standort", "Innsbruck · Remote · Zürich"]],
  ...
  en: {
    ...
    facts: [["Role", "Lead Fullstack Developer"], ["Education", "BSc Computer Science · University of Innsbruck"], ["Location", "Innsbruck · Remote · Zurich"]],
